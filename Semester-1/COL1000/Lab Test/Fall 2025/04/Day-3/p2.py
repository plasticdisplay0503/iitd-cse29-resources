"""Boilerplate for Problem 2: Function Call Counter Decorator."""

from typing import Callable, Any, Dict # Do not change

# Global dictionary to store function call counts
calls: Dict[str, int] = {} # Do not change
...
def solution(tc):
    ...
    # Call the function (this will update the global calls dictionary)
    result = func(arg) if arg is not None else func()
    
    # Return the global calls dictionary
    return calls
